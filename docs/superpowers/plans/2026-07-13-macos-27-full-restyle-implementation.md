...
- Final artifact: `<repository-root>/dist/ClipVault.app`. Historical untracked `audits/` directories remain untouched. No push, merge, upload, privacy-setting change, consent revocation, or destructive clip action was performed.
