...
## Blocking owner/account work

- [ ] Create or confirm App Store Connect app record and bundle provisioning.
- [ ] Publish a public HTTPS privacy policy URL and support URL/contact.
- [ ] Complete privacy labels, age rating, accessibility declarations, content-rights, export-compliance, and EU DSA trader status truthfully.
- [ ] Confirm copyright, category, price, territories, release mode, and phased release.
- [ ] Provide review contact. No demo account is needed because the app has no account.
